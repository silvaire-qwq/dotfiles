...
FULL_COLOR=1e1e2e    # 填充颜色 Def: 000000 , Need IMG_RESIZE=fit
FILTER=Lanczos3      # 缩放图像时使用的滤镜 Def: Lanczos3 [Nearest, bilinear, Catmullrom, Mitchell, Lanczos3]
TYPE=fade            # 切换过渡 Def: simple [none, simple, fade, left, right, top, bottom, wipe, wave, grow, center, any, outer, random]
STEP=90              # 过渡效果速度 ( TYPE=simple STEP=2 ), Def: 90
...
DURATION=4           # 完成过度效果时间 (单位 s) Def: 3, 不适用于 TYPE=simple
BEZIER=0,0.55,0.45,1 #0.85,0,0.15,1 #特别平滑:0,0.55,0.45,1 #.1,1,.1,.4 #.1,1,.1,.1 Def: 54,0,.34,.99 , (https://cubic-bezier.com/#.1,.9,.79,.11, https://easings.net/zh-cn)
